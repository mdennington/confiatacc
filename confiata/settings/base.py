# flake8: noqa
"""
Django settings for confiata project.
...
DJANGO_ROOT = root.path('confiata')
...
WSGI_APPLICATION = 'confiata.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///confiata'),
}
